const challenges = [
  ...
  },
  {
    ...
    category: 'Injection',
    difficulty: 'Medium',
    description: 'The login page builds its authentication query by concatenating your username directly into the SQL statement. Bypass the password check and sign in as admin.',
    hints: [
      'The server executes: SELECT * FROM users WHERE username = \'<your input>\' AND password = \'<md5 hash>\'.',
      'Try username admin\'-- with any password.',
      'The -- comments out the rest of the WHERE clause, skipping the password check.',
      'Alternatively, \' OR 1=1-- matches every user.',
    ],
    flag: 'FLAG{l0g1n_sql1}',
  },
  {
    id: 'stored_xss',
    title: 'Stored XSS',
