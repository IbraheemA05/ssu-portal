const challenges = [
  ...
  },
  {
    ...
    category: 'Injection',
    difficulty: 'Hard',
    description: 'The course search builds a SQL query by concatenating your input directly into the statement. Break out of the string literal to manipulate the query and read more than you should.',
    hints: [
      ...
      'Use a payload like \' OR 1=1-- to match every row, or a UNION SELECT to read from other tables (e.g. users).',
      'Rows hidden from the normal catalog contain the flag.',
    ],
